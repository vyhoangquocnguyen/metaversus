...
relative z-10`}
  >
    <motion.div
      ...
      className={`${styles.innerWidth} mx-auto flex sm:flex-row 
      flex-col gap-6`}
    >
      <motion.div
        variants={fadeIn('right', 'tween', 0.2, 1)}
        className='flex-[0.5] lg:max-w-[370px] flex-justify-end
      flex-col gradient-05 sm:p-8 p-4 rounded-[32px] bprder-[1px] 
      ...
      >
        ...
        <p
          ...
          text-[18px] sm:leading-[45.6px] leading-[39.6px] text-white'
        >
